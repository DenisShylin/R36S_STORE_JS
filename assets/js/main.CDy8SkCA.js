var C=(e,o,t)=>new Promise((i,n)=>{var l=a=>{try{d(t.next(a))}catch(m){n(m)}},c=a=>{try{d(t.throw(a))}catch(m){n(m)}},d=a=>a.done?i(a.value):Promise.resolve(a.value).then(l,c);d((t=t.apply(e,o)).next())});(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const l of n)if(l.type==="childList")for(const c of l.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function t(n){const l={};return n.integrity&&(l.integrity=n.integrity),n.referrerPolicy&&(l.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?l.credentials="include":n.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function i(n){if(n.ep)return;n.ep=!0;const l=t(n);fetch(n.href,l)}})();const N="modulepreload",F=function(e){return"/R36S_STORE_JS/"+e},M={},W=function(o,t,i){let n=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),d=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));n=Promise.allSettled(t.map(a=>{if(a=F(a),a in M)return;M[a]=!0;const m=a.endsWith(".css"),u=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${u}`))return;const g=document.createElement("link");if(g.rel=m?"stylesheet":N,m||(g.as="script"),g.crossOrigin="",g.href=a,d&&g.setAttribute("nonce",d),document.head.appendChild(g),m)return new Promise((w,y)=>{g.addEventListener("load",w),g.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${a}`)))})}))}function l(c){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=c,window.dispatchEvent(d),!d.defaultPrevented)throw c}return n.then(c=>{for(const d of c||[])d.status==="rejected"&&l(d.reason);return o().catch(l)})};function O(){let e=!1,o=window.scrollY,t=null;const i=document.querySelector(".header"),n=document.querySelector(".burger-btn"),l=document.querySelector(".burger-line"),c=document.querySelector(".mobile-menu"),d=document.querySelectorAll(".our-menu-link, .mobile-menu__link");function a(){const r=window.scrollY,f=o<r;t&&clearTimeout(t),r>100?w(!f):w(!0),o=r,g(r>0),t=setTimeout(()=>{},150)}function m(){e=!e,u()}function u(){e?(i.classList.add("menu-open"),n.setAttribute("aria-expanded","true"),l.classList.add("open"),c.classList.add("open"),document.body.style.overflow="hidden"):(i.classList.remove("menu-open"),n.setAttribute("aria-expanded","false"),l.classList.remove("open"),c.classList.remove("open"),document.body.style.overflow="unset")}function g(r){r?i.classList.add("scrolled"):i.classList.remove("scrolled")}function w(r){r?(i.classList.add("visible"),i.classList.remove("hidden")):(i.classList.add("hidden"),i.classList.remove("visible"))}function y(r){r.preventDefault();const f=r.currentTarget.getAttribute("href"),x=f.replace("#",""),s=document.getElementById(x);s&&(w(!0),setTimeout(()=>{const h=i.offsetHeight,E=s.getBoundingClientRect().top+window.scrollY-h;window.scrollTo({top:E,behavior:"smooth"}),e&&(e=!1,u()),window.history.replaceState(null,"",`${window.location.pathname}${f}`),setTimeout(()=>{o=window.scrollY},100)},50))}function S(){if(window.location.hash){const r=window.location.hash.replace("#",""),f=document.getElementById(r);f&&setTimeout(()=>{const x=i.offsetHeight,h=f.getBoundingClientRect().top+window.scrollY-x;window.scrollTo({top:h,behavior:"smooth"})},100)}}window.addEventListener("scroll",a),window.addEventListener("resize",()=>{!(window.innerWidth<=768)&&e&&(e=!1,u())}),n&&n.addEventListener("click",m),d.forEach(r=>{r.addEventListener("click",y)}),S()}function G(){console.log("Hero section initialized");const e=document.querySelector(".hero"),o=document.querySelector(".hero__console-img"),t=document.querySelector(".hero__image source"),i=document.querySelector(".hero__content"),n=document.querySelector(".hero__description--desktop"),l=document.querySelector(".hero__description--mobile"),c=document.querySelector(".hero__pricing"),d=document.getElementById("buy-button"),a=document.getElementById("more-details-button"),m="/img/hero/herou1_1x_.png",u="/img/hero/herou1_2x_.png";console.log("Using image paths:",{heroImage1x:m,heroImage2x:u});function g(){if(!o){console.error("Hero image element not found");return}console.log("Setting hero image paths"),o.onerror=()=>{console.error("Failed to load hero image:",o.src),e.classList.add("hero--loaded")},o.onload=()=>{console.log("Hero image loaded successfully"),e.classList.add("hero--loaded")},o.src=u,o.srcset=`${m} 1x, ${u} 2x`,o.complete&&(console.log("Hero image already loaded (from cache)"),e.classList.add("hero--loaded"))}function w(){t?t.srcset=m:console.warn("Hero image source element not found")}function y(){const x=window.innerWidth>992;n&&l&&c&&(x?(n.style.display="block",l.style.display="none"):(n.style.display="none",l.style.display="block"))}function S(){if(!i)return;new IntersectionObserver(s=>{s.forEach(h=>{h.isIntersecting&&h.target.classList.add("animate-in")})},{threshold:.1}).observe(i)}function r(){d&&d.addEventListener("click",()=>{window.open("https://www.aliexpress.com/item/1005007171465465.html","_blank","noopener,noreferrer")}),a&&a.addEventListener("click",f)}function f(x){x.preventDefault();const s=document.getElementById("features"),h=document.querySelector(".header");if(s&&h){const v=h.offsetHeight,E=s.getBoundingClientRect().top,R=window.scrollY||window.pageYOffset,p=E+R-v;window.scrollTo({top:p,behavior:"smooth"}),window.history.replaceState(null,"",`${window.location.pathname}#features`)}}g(),w(),y(),S(),r(),window.addEventListener("resize",y)}function z(e){let o=null,t=null,i=!1,n=0,l=null;(()=>{const r="modal-about-styles";if(document.getElementById(r))return;const f=document.createElement("style");f.id=r,f.textContent=`
      .modal-about-overlay {
        position: fixed;
        top: 0;
        left: 0;
    ...
    `,document.head.appendChild(f)})();function d(r){r.key==="Escape"&&i&&y()}function a(){const r=document.createElement("div");return r.className="modal-about-overlay",r.style.display="none",r.addEventListener("click",y),e.appendChild(r),r}function m(){return t?t.title==="Extensive color selection"&&t.colorImages?`
        <img
          src="${t.colorImages[n]}"
    ...
    `:""}function u(){(t==null?void 0:t.title)==="Extensive color selection"&&t.colorImages&&(l&&clearInterval(l),l=setInterval(()=>{n=n===t.colorImages.length-1?0:n+1;const r=o.querySelector(".modal-about-image");r&&(r.src=t.colorImages[n],r.alt=`R36S Color Variant ${n+1}`)},1e3))}function g(){if(!o||!t)return;o.innerHTML=`
...
Never compromise between portability and performance - the R36S delivers both in a perfectly portable package.`,videoUrl:Q,imageAlt:"R36S Portability"}];function n(){e.innerHTML=i.map(m=>`
    ...
    `).join("")}function l(m){const u=m.currentTarget,g=u.getBoundingClientRect();o={x:m.clientX-g.left,y:m.clientY-g.top},u.style.setProperty("--mouse-x",`${o.x}px`),u.style.setProperty("--mouse-y",`${o.y}px`)}function c(m){const u=parseInt(m.currentTarget.dataset.featureId);console.log("Клик по кнопке карточки ID:",u);const g=i.find(w=>w.id===u);if(!g){console.error("Данные для карточки не найдены");return}t||(t=z(document.body)),t.open(g)}function d(){document.querySelectorAll(".about-card").forEach(u=>{u.addEventListener("mouseenter",()=>{parseInt(u.dataset.id),u.classList.add("active")}),u.addEventListener("mouseleave",()=>{u.classList.remove("active")}),u.addEventListener("mousemove",l)}),document.querySelectorAll(".about-card__button").forEach(u=>{u.addEventListener("click",c)})}function a(){document.querySelectorAll(".about-card").forEach(u=>{u.removeEventListener("mouseenter",()=>{}),u.removeEventListener("mouseleave",()=>{}),u.removeEventListener("mousemove",l)}),document.querySelectorAll(".about-card__button").forEach(u=>{u.removeEventListener("click",c)}),t&&(t.destroy(),t=null)}try{console.log("Рендерим карточки..."),n(),console.log("Устанавливаем обработчики событий..."),d(),console.log("Инициализация About завершена успешно")}catch(m){console.error("Ошибка при инициализации About:",m)}return{cleanup:a}}document.addEventListener("DOMContentLoaded",()=>{q()});function q(){const e=document.getElementById("features"),o=document.getElementById("featuresVideo"),t=document.getElementById("soundToggleButton"),i=document.getElementById("volumeOffIcon"),n=document.getElementById("volumeOnIcon"),l=document.getElementById("buyButton"),c=document.getElementById("moreInfoButton");o&&(o.volume=.5,o.play().catch(d=>{console.log("Автовоспроизведение не удалось:",d)})),l&&l.addEventListener("click",ne),c&&c.addEventListener("click",re),t&&t.addEventListener("click",()=>oe(o,i,n)),window.addEventListener("scroll",()=>{ie(e,o,i,n)})}function oe(e,o,t){if(e)if(e.muted=!e.muted,e.muted){o.style.display="block",t.style.display="none";const i=document.getElementById("soundToggleButton");i&&i.setAttribute("aria-label","Включить звук")}else{e.volume=.5,o.style.display="none",t.style.display="block";const i=document.getElementById("soundToggleButton");i&&i.setAttribute("aria-label","Выключить звук")}}function ie(e,o,t,i){if(!e||!o||o.muted)return;const n=e.getBoundingClientRect();if(!(n.top<window.innerHeight&&n.bottom>0)){o.muted=!0,t.style.display="block",i.style.display="none";const c=document.getElementById("soundToggleButton");c&&c.setAttribute("aria-label","Включить звук")}}function ne(){window.open("https://www.aliexpress.com/item/1005007171465465.html?spm=a2g0o.store_pc_home.0.0.70583a88IDCuNJ&pdp_npi=4%40dis%21UAH%214%C2%A0485%2C21%20%D0%B3%D1%80%D0%BD.%211%C2%A0472%2C53%20%D0%B3%D1%80%D0%BD.%21%21%21767.45%21251.96%21%40211b498b17390151033607761d21d7%2112000039694115852%21sh%21UA%211927913003%21X","_blank","noopener,noreferrer")}function re(){const e=document.getElementById("features-r36s"),o=document.querySelector(".header");if(e&&o){const t=o.offsetHeight,i=e.getBoundingClientRect().top,n=window.scrollY||window.pageYOffset,l=i+n-t;window.scrollTo({top:l,behavior:"smooth"}),window.history.replaceState(null,"",`${window.location.pathname}#features-r36s`)}}function se(){console.log("Инициализация секции Categories");const e=document.querySelector(".categories__video"),o=document.querySelector(".categories__video-placeholder"),t=document.getElementById("categories"),i=document.querySelector(".categories__content"),n=document.querySelector(".categories__video-play"),l=document.querySelector(".categories__video-mute"),c=document.querySelector(".categories__video-slider"),d=document.querySelector(".categories__video-container"),a=document.querySelector(".categories__video-time span:first-child"),m=document.querySelector(".categories__video-time span:last-child");if(!t)return console.error("Секция Categories не найдена в DOM"),{};i||console.warn("Элемент categories__content не найден");let u=!1,g=!0,w=!1,y=!1;const S=p=>{if(isNaN(p)||p<0)return"0:00";const b=Math.floor(p/60),k=Math.floor(p%60);return`${b}:${k.toString().padStart(2,"0")}`};function r(){n&&(n.innerHTML=u?`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
         ...
         </svg>`)}function x(){if(!(!e||y)){if(u)e.pause(),u=!1;else{const p=e.play();if(p!==void 0){p.then(()=>{console.log("Воспроизведение видео успешно"),u=!0}).catch(b=>{console.warn("Не удалось воспроизвести видео:",b),u=!1}).finally(()=>{r()});return}else u=!0}r()}}function s(p){if(!e)return;for(;e.firstChild;)e.removeChild(e.firstChild);const b=document.createElement("source");b.src=p,b.type="video/mp4";const k=document.createTextNode("Your browser does not support the video tag.");e.appendChild(b),e.appendChild(k),e.load()}function h(){d&&(y=!0,e&&(e.style.display="none"),d.innerHTML=`
...
`).forEach(v=>{f+=`<p>${v.trim()}</p>`}),f+="</div>",s.content.images&&(f+=`
  ...
  `;const o="/R36S_STORE_JS/";console.log("Режим:","production"),console.log("Базовый путь:",o);try{const[t,i]=yield Promise.all([I("Header").catch(()=>'<header class="header">Заголовок сайта</header>'),pe("MobileMenu").catch(()=>'<div class="mobile-menu"></div>')]),n=window.location.pathname.replace(o,"/");if(n==="/"||n==="/index.html"){const l={hero:I("Hero"),about:I("About"),features:I("Features"),categories:I("Categories"),articles:I("Articles"),reviews:I("Reviews"),contact:I("Contact"),products:I("Products"),footer:I("Footer")},c=yield Promise.allSettled(Object.values(l)),d={};Object.keys(l).forEach((a,m)=>{d[a]=c[m].status==="fulfilled"?c[m].value:`<section id="${a}" class="error-section">Ошибка загрузки ${a}</section>`}),e.innerHTML=`
        ${t}
        ${i}
        ...
        ${d.footer}
      `,_("Header",O),_("MobileMenu",P),_("Hero",G),_("About",te),_("Features",q),_("Categories",se),_("Articles",ae),_("Reviews",le),_("Contact",ce),_("Products",ue),_("Footer",$),_("Modal",D)}else{const l=yield I("Footer").catch(()=>'<footer class="footer"><p>© 2025</p></footer>');e.innerHTML=`
        ${t}
        ${i}
        <div class="not-found">
          <div class="container">
        ...
        ${l}
      `,_("Header",O),_("MobileMenu",P),_("Footer",$)}console.log("Приложение инициализировано")}catch(t){throw console.error("Ошибка при инициализации приложения:",t),e.innerHTML=`
      <div class="error">
        <h1>Ошибка</h1>
