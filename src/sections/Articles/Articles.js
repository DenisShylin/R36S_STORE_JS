// Articles.js - Инициализатор секции Articles
export function initArticles() {
  ...
  console.log('Инициализация секции Articles');
  ...
  // Создаем HTML структуру для статей
  ...
  // Создаем статьи и добавляем их в контейнер
  articles.forEach(article => {
    ...
    article.sections.forEach(section => {
      ...
      contentContainer.className = 'article__content';
      ...
      articleElement.appendChild(sectionContainer);
    });
